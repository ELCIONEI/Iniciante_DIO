...
CREATE TABLE `chamados` (
  ...
  `data DATE` varchar(45) DEFAULT NULL,
...
--
-- Table structure for table `dados_cadastro`
--

DROP TABLE IF EXISTS `dados_cadastro`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dados_cadastro` (
  `dados_cadastro` int NOT NULL,
  `nome` varchar(45) DEFAULT NULL,
  `setor` varchar(45) DEFAULT NULL,
  `contato` int DEFAULT NULL,
  `login` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`dados_cadastro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dados_cadastro`
--

LOCK TABLES `dados_cadastro` WRITE;
/*!40000 ALTER TABLE `dados_cadastro` DISABLE KEYS */;
/*!40000 ALTER TABLE `dados_cadastro` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-08-29 13:04:55
